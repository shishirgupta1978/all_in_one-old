...
export const apiSlice = createSlice({
	...
	extraReducers: (builder) => {
		builder
			...
			.addCase(logout.fulfilled, (state) => {state.user.refresh=null;state.user = null;state.userprofile =null;localStorage.removeItem("authTokens");toast.success("Successfully logout." )})
